...
export default function SearchBar() {
  ...
  return (
    <div className="w-full max-w-3xl mx-auto">
      <div className={`flex w-full border ${isDark ? " border-gray-800 " : " border-gray-500 "} rounded-full px-2 flex-row items-stretch sm:items-center ${isDark ? " darkModeBg " : " bg-white "}`}>
