...
export default function SearchBar() {
  ...
  return (
    <div className="w-full max-w-3xl mx-auto">
      <div className="flex items-center w-full border rounded-full bg-white shadow-sm px-2">
        ...
        <input
          ...
          onKeyDown={onKeyDown}
          className="flex-1 px-3 py-3 outline-none text-black text-base"
        />

        {/* Custom Location Dropdown with Icon */}
