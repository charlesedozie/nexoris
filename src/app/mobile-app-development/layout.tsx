...
<DynamicContent type="h1" title='Mobile apps that are fast, stable, and easy to use'  />
</div>
<p className="my-8 p-base-res text-center px-[1%] lg:px-[10%] xl:px-[16%] 2xl:px-[22%]">We design, build, and support iOS and Android apps with clear user flows, dependable releases, and strong performance from day one.</p>
