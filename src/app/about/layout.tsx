...
<DynamicContent type="h1" title='About Nexoris Technologies'  />
</div>

<DynamicContent type="p4" title='We design, build, and host dependable digital products. From websites and mobile apps to custom software, we deliver on schedule and keep everything stable after launch. With Nexoris Cloud Solutions, one team manages both your product and its hosting.' css='my-8 p-base-res text-center px-[1%] lg:px-[10%] xl:px-[16%] 2xl:px-[22%]'  />
...
<DBtn title='Explore Nexoris Cloud' css1='bg-white text-black' css2='bg-[#141313] text-gray-100' iconcss1='bg-[#E6E8EC] text-gray-900' iconcss2='bg-[#141313] text-gray-200' url='/cloud-solutions' />
</div>
</div>
</div>
</>    
