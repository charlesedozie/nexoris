...
<DynamicContent type="h1" title='Product Design & Management' />
<DynamicContent type="p4" title='We plan, design, and manage your product from idea to launch, then keep improving it with real data'  /></div>
...
<DynamicContent
type="img"
src="/product-design.webp"
title="Product Design & Management"
teaser="Product Design & Management"
...
<div className="mt-[9%] content-padding">
<DynamicContent type="h2" title='What You Get' />
<DynamicContent type="p" title='A fast, low-risk path from idea to working product, with clear ownership and steady improvements.'  />
</div>
